...
```bash
python getprob.py  \
    -f /home/jorge/Documents/data/sgr/base_sample/lowbulge/49_likelihood_tf3/vvv_withextinction_tf3corr_like.fits \
    -o /home/jorge/Documents/data/sgr/base_sample/lowbulge/73_totalprob_tf3/vvv_ext_tf3corr_pm+parallax-prob.fits \
    -eta 0.01 \
    -niter 2
```
